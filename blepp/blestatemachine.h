...
namespace BLEPP
{
	...
	class BLEGATTStateMachine
	{
		...
		public:
			...
			void connect_blocking(const std::string& address);
            void connect_blocking_randaddr(const std::string& address);
            void connect_nonblocking_randaddr(const std::string& address);
			void connect_nonblocking(const std::string& address);
